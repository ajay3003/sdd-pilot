...
public static class WorkflowDefinitions
{
    public static readonly List<WorkflowStepDefinition> AllSteps = new()
    {
        ...
        new()
        {
            StepKey = "SpecificationReview",
            Title = "Specification Review",
            Description = "Run analysis to extract requirements and tests",
            Route = "extract",
            ActionLabel = "Run Specification Review",
        ...
        new()
        {
            ...
            RequiredPreviousApprovals = new() { "SpecificationReview" },
            RequiresManualReview = true,
            RequiresApproval = true,
            Color = "#2563eb"
        },
