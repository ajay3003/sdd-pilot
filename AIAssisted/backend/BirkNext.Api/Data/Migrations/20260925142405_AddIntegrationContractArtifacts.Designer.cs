...
namespace BirkNext.Api.Data.Migrations
{
    ...
    [Migration("20260925142405_AddIntegrationContractArtifacts")]
    partial class AddIntegrationContractArtifacts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BirkNext.Api.Models.GraphQlSchemaArtifactRecord", b =>
                {
            ...
            modelBuilder.Entity("BirkNext.Api.Models.IntegrationContractArtifactRecord", b =>
                {
                    ...
                    b.HasKey("EnvironmentId", "IntegrationId", "Role");

                    b.ToTable("integration_contract_artifacts", (string)null);
                });

            modelBuilder.Entity("BirkNext.Api.Models.IntegrationDefinitionRecord", b =>
                {
                    b.Property<string>("EnvironmentId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                    ...
                    b.HasIndex("EnvironmentId", "PlatformId")
                        .HasDatabaseName("ix_integration_definitions_environment_platform");

                    b.ToTable("integration_definitions", (string)null);
                });

            modelBuilder.Entity("BirkNext.Api.Models.IntegrationEnvironmentStateRecord", b =>
                {
                    b.Property<string>("EnvironmentId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                    ...
                    b.Property<DateTimeOffset?>("LegacyImportedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("legacy_imported_at");
            ...
            modelBuilder.Entity("BirkNext.Api.Models.IntegrationPlatformRecord", b =>
                {
                    ...
                    b.ToTable("integration_platforms", (string)null);
                });

            modelBuilder.Entity("BirkNext.Api.Models.IntegrationQualitySnapshotRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("BaselineIdentityVersion")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("IntegrationQualitySnapshots");
                });

            modelBuilder.Entity("BirkNext.Api.Models.IntegrationReviewRunRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EnvironmentId", "CompletedAt")
                        .HasDatabaseName("ix_integration_review_runs_environment_completed");

                    b.ToTable("integration_review_runs", (string)null);
                });
            ...
            modelBuilder.Entity("BirkNext.Api.Models.WorkspaceReviewProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ArtifactSetHashAtApproval")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("artifact_set_hash_at_approval");

                    b.Property<string>("ArtifactSetHashAtReview")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("artifact_set_hash_at_review");
                    ...
                    b.Property<string>("ReviewContextVersionAtApproval")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("review_context_version_at_approval");
                    ...
                    b.Property<int?>("WorkspaceVersionAtApproval")
                        .HasColumnType("integer")
                        .HasColumnName("workspace_version_at_approval");

                    b.HasKey("Id");

                    b.HasIndex("WorkspaceId", "ApprovalState")
                        .HasDatabaseName("ix_workspace_review_progress_workspace_approval");

                    b.HasIndex("WorkspaceId", "StepKey")
                        .IsUnique()
                        .HasDatabaseName("ix_workspace_review_progress_workspace_key");

                    b.ToTable("workspace_review_progress", (string)null);
                });
