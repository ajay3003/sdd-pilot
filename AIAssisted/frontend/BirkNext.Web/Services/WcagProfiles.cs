...
public static class WcagProfiles
{
    ...
    public static WcagAssessmentProfile Norwegian { get; } = new(NorwegianId, "Norwegian legal requirements", "Norway",
    ...
    public static WcagAssessmentProfile Extended => new(ExtendedId, "Extended WCAG review", "None", "Optional",
    ...
    public static WcagAssessmentProfile Resolve(string id)
    {
        ...
        if (id is "legacy-21-A" or "legacy-21-AA" or "legacy-22-A" or "legacy-22-AA")
        {
            ...
            return new(id, "Legacy WCAG assessment", "Unknown", "Unknown", version,
