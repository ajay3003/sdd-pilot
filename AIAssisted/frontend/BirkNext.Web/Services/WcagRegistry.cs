...
public static class WcagRegistry
{
    ...
    public static IReadOnlyList<WcagCriterionDefinition> All { get; } = Array.AsReadOnly(new[]
    {
        ...
        D("2.4.7", WcagLevel.AA, "Focus Visible", interaction: true),
