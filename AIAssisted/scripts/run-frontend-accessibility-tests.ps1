param(
    [string]$TestFilter = "Category=FrontendAccessibilityIntegration"
)
...
if ($selected -eq 0)
{
    Write-Host "ERROR: Accessibility gate selected 0 tests for filter '$TestFilter'." -ForegroundColor Red
    exit 2
}
